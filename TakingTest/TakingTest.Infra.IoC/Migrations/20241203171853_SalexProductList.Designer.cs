...
namespace TakingTest.Infra.Migrations
{
    ...
    [Migration("20241203171853_SalexProductList")]
    partial class SalexProductList
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TakingTest.Domain.Entities.Sale", b =>
                {
                    ...
                    b.Property<long>("SalesFinalPrice")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ProductSale", b =>
                {
                    b.HasOne("TakingTest.Domain.Entities.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TakingTest.Domain.Entities.Sale", null)
                        .WithMany()
